...
function createStyles(colors: ColorTokens) {
	...
	tip: { width: "100%", flexDirection: "row", gap: 8, alignItems: "center", backgroundColor: colors.successSoft, borderWidth: 1, borderColor: colors.success, borderRadius: 10, padding: 12 },

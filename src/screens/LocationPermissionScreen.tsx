	...
	return (
		<View style={[styles.safeArea, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 16 }]}>
			...
			<View style={styles.footer}>
				<PrimaryButton label="Permitir ubicación" onPress={handleAllow} loading={asking} />
...
function createStyles(colors: ColorTokens) {
	...
	featureText: { flex: 1, color: colors.defaultText, fontFamily: typography.family.regular, fontSize: typography.sizes.caption },
	footer: { gap: space.sm },
	skipBtn: { height: 44, alignItems: "center", justifyContent: "center" },
	skipText: { color: colors.mutedText2, fontFamily: typography.family.medium, fontSize: typography.sizes.label },
	});
}
